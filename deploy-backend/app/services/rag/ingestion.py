...
# Knowledge base path - works both locally and in Docker
# In Docker: /app/knowledge, Locally: project_root/knowledge
import os
...
class IngestionService:
    ...
    async def ingest_all_knowledge(self) -> Dict[str, Any]:
        ...
        # Clear old data before ingesting (ensures fresh index with latest files)
        await retriever_service.clear_collection()
        logger.info("Cleared old knowledge base data")
